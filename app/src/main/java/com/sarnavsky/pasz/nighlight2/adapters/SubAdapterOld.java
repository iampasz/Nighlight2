...
//
//public class SubAdapterOld extends RecyclerView.Adapter<SubAdapterOld.ListSubHolder> {
//
...
//    ChoseSub choseSub;
//
//    public SubAdapterOld(List<ProductDetails.SubscriptionOfferDetails> list, ChoseSub choseSub){
//        this.list = list;
