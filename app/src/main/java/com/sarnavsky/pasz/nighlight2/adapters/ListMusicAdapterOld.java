...
//
//public class ListMusicAdapterOld extends RecyclerView.Adapter<ListMusicAdapterOld.ListMusicHolder> {
//
...
//
//    public ListMusicAdapterOld(PlayMyMusic playMyMusic, ArrayList<MyAudio> arrayList) {
