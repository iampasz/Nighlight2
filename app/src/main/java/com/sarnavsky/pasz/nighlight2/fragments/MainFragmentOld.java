...
//                switch (button) {
//                    case 1:
//                        ListFragmentOld listFragment = (ListFragmentOld) getChildFragmentManager().findFragmentByTag("LIST_FRAGMENT");
//
//                        if (listFragment == null) {
//                            getParentFragmentManager()
//                                    .beginTransaction()
//                                    .setCustomAnimations(R.anim.from_bottom, R.anim.disepire)
//                                    .replace(R.id.mainContainer, new ListFragmentOld(), "LIST_FRAGMENT")
//                                    .commit();
//                        }
//                        break;
//                    case 2:
...
//                        getParentFragmentManager()
//                                .beginTransaction()
//                                .replace(R.id.mainContainer, ColorPickerOld.init(0), "ColorPicker")
//                                .commit();
//                        break;
//                    case 2:
//                        getParentFragmentManager()
//                                .beginTransaction()
//                                .replace(R.id.mainContainer, ColorPickerOld.init(1), "ColorPicker")
//                                .commit();
//                        break;
//                }
//            }
