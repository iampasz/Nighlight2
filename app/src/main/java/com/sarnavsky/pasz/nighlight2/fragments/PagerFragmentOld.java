...
//
//
//public class PagerFragmentOld extends Fragment {
//
//    Nightlighter myNightlighter;
//    Context ctx;
//
//    public static PagerFragmentOld newInt(Nightlighter nightlighter) {
//
//        PagerFragmentOld pageFragment = new PagerFragmentOld();
